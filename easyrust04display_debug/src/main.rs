fn main() {
    // Simple variables in Rust can be printed with {} inside println!. 
    // But some variables can't, and you need to debug print.
    print!("This will not print a new line");
    println!(" so this will be one the same line");
